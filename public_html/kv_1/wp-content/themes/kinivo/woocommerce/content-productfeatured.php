...
<?php if( $product->product_type == 'simple'){ ?>
	<li>
		...
		<p class="prices">
			...
			<span>Sale <?php echo get_woocommerce_currency_symbol().$product->get_price().' '.get_woocommerce_currency(); ?></span><br />
		</p>
	</li>
<?php }else{ ?>
	<?php if( $product->product_type == 'variable'){ ?>
		<li>
			...
			<p class="prices">
				...
				<span>Sale <?php echo get_woocommerce_currency_symbol().$product->get_variation_sale_price('min',false  ).' '.get_woocommerce_currency(); ?></span><br />
			</p>
		</li>
	<?php } ?>
<?php } ?>