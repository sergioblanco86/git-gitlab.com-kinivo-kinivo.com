...
<div class="checkout-login-content">
	<div class="wrapper wrap">
		<div class="col">
			...
			<fieldset>
				<a href="" class="button green standar-nowidth">LOG IN</a>
			</fieldset>
			<a href="" class="forgot-password">Forgot your password?</a>

			<h2>Or you can Log In using:</h2>
			<div class="social-login">
				<a href="" class="icn tw"></a>
				<a href="" class="icn fb"></a>
				<a href="" class="icn gp"></a>
				<a href="" class="icn yh"></a>
			</div> -->
		...
		<div class="col">
			...
			<a href="" class="button green standar-nowidth">CREATE ACCOUNT</a> -->
