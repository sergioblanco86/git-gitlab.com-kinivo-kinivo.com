...
<script type="text/javascript">
  jQuery('document').ready(function($){
    ...
    commentform.submit(function(){
      ...
      statusdiv.html('<p>Sending cooment...</p>');
      ...
      $.ajax({
        ...
        error: function(XMLHttpRequest, textStatus, errorThrown){
          ...
          if( textArea.trim() == ''){
            statusdiv.html('<p class="ajax-error" >Please fill all the fields. </p>');
            commentform.find('textarea[name=comment]').val(textArea.trim());
          }else{
            statusdiv.html('<p class="ajax-error" >You have commented this before. </p>');
          }

        },
        success: function(data, textStatus){
          statusdiv.html('<p class="ajax-success" >Thanks for your comment.</p>');
