...
<form id="order_review" method="post">
	...
	<table class="shop_table checkout-step checkout-step-3">
		<thead>
			<tr>
	...
	<div id="payment" class="checkout-step checkout-step-2">
		...
		<div class="form-row">
			...
			<?php
				...
				echo apply_filters( 'woocommerce_pay_order_button_html', '<input type="submit" class="button alt submit-button green standar-nowidth" id="place_order" value="' . esc_attr( $pay_order_button_text ) . '" data-value="' . esc_attr( $pay_order_button_text ) . '" />' );
			?>			
