...
if ( $attachment_ids ) {
	...
	<div class="thumbnails">
		...
		foreach ( $attachment_ids as $attachment_id ) {
			...
			$image_link_full = wp_get_attachment_url( $attachment_id );
			...
			echo '<li><a href="'.$image_link_full.'" class="thumb-img" data-rel="prettyPhoto[product-gallery]" data-href="'.$image_link_full.'"style="background-image: url('.$image[0].');"></a></li>';
