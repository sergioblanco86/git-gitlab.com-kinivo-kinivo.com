...
?>
<tr class="shipping-table-totales">
	<td class="shipping-title-text"><?php
		if ( $show_package_details ) {
			printf( __( '<span class="cart_shipping">'.$GLOBALS['cart_shipping'].'</span> #%d', 'woocommerce' ), $index + 1 );
		} else {
			_e( '<span class="cart_shipping">'.$GLOBALS['cart_shipping'].'</span>', 'woocommerce' );
		}
	?>
		<div class="question-mark">?
			<div class="pop">
				<span class="close">X</span>
				<?php echo '<span class="cart_shipping_question_mark">'.$GLOBALS['cart_shipping_question_mark'].'</span>'; ?>
			</div>
		</div>
	</td>
