...
if ( isset($_GET['wc-social-login-missing-email']) ) {
	if ( $_GET['wc-social-login-missing-email'] ) {
		echo '<style>
			.woocommerce-info{ display: none;}
			.woocommerce-info.email-missing{ display:block;}
		</style>';
	}
}
		...
		<div class="dash">
			...
			<div class="personal-information">
				...
				<div class="user-information-content change-info-content" <?php if($_GET['address_saved']){ echo 'style="display:none;"';} ?>>
					<div class="woocommerce-info email-missing">Please enter your email address to complete your registration</div>
