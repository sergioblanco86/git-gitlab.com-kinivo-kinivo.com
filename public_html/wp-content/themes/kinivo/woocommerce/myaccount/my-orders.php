...
?>
	...
	<table class="shop_table my_account_orders information-table">
		...
		<thead>
			<tr>
				<th class="table-header">Order Information</th>
				<th class="table-header">Products Ordered</th>
				<th>
					<!-- <select name="" id="">
				...
				?><tr>
					...
					<td class="order-actions">
							...
							if ($actions) {
								foreach ( $actions as $key => $action ) {
									if ($action['name'] == "View") {
										...
										echo '<a  class="button ' . sanitize_html_class( $key ) . ' green standar-nowidth" href="'.$action['url'].'">' . esc_html( $action['name'] ) . '</a>';
									}
                        ...
                        <script>
                                ...
                                new DESK.Widget({ 
                                        ...
                                        fields: { 
                                                ticket: { 
													...
													//priority: &#x27;&#x27;,
													//subject: &#x27;&#x27;,
													custom_order_number: '<?php echo $order->get_order_number(); ?>',
													//custom_return_issue: &#x27;&#x27;
                                                }, 
                                                interaction: { 
                                                ...
                                                email: { 
                                                    subject: 'Return/Question - Order ID: <?php echo $order->get_order_number(); ?>', 
                                                    body: 'Order ID: <?php echo $order->get_order_number(); ?>\n----------------\nComments:\n' 
                                                }, 
                                                customer: { 
                                                    //company: &#x27;&#x27;,
					                                //desc: &#x27;&#x27;,
							...
							<p class="amazon-info">Most responses will be received within 24 hours during business days</p>
