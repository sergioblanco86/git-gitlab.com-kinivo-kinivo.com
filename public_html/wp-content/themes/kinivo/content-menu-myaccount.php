...
$multiple = get_bloginfo('url').'/my-account/multiple-shipping-addresses/';
if($imgURL == ''){
...
<ul class="menu">
	...
	<li>
		<a href="<?php bloginfo('url'); ?>/my-account" <?php if($my_account == $permalink || $multiple == $permalink){ echo 'class="active"';} ?> >Personal Information</a>
	</li>
</ul>