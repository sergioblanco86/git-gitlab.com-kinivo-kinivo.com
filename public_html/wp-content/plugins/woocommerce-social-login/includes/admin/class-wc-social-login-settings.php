...
class WC_Settings_Social_Login extends WC_Settings_Page {
	...
	public function get_settings() {
		...
		return apply_filters('woocommerce_social_login_settings', array(
			...
			array(
				'name'     => __( 'Display Social Login buttons on:', WC_Social_Login::TEXT_DOMAIN ),
				'desc_tip' => __( 'Control where Social Login buttons are displayed.', WC_Social_Login::TEXT_DOMAIN ),
				'id'       => 'wc_social_login_display',
				'type'     => 'multiselect',
				'class'    => 'chosen_select',
				'options' => array(
					'checkout'        => __( 'Checkout', WC_Social_Login::TEXT_DOMAIN ),
					'my_account'      => __( 'My Account', WC_Social_Login::TEXT_DOMAIN ),
					'checkout_notice' => __( 'Checkout Notice', WC_Social_Login::TEXT_DOMAIN ),
				),
				'default'  => array(
					'checkout',
					'my_account',
			...
			array(
				'name'     => __( 'Display "Link Your Account" button on Thank You page', WC_Social_Login::TEXT_DOMAIN ),
				'desc'     => __( 'Enable to allow customers to link their social account on the Thank You page for faster login & checkout next time they purchase.', WC_Social_Login::TEXT_DOMAIN ),
			...
			array(
				...
				'default'  => __( 'Login or Register quickly with a social account.', WC_Social_Login::TEXT_DOMAIN ),
				'type'     => 'textarea',
