...
class WC_Social_Login_Provider_Amazon extends WC_Social_Login_Provider {
	...
	public function __construct( $base_auth_path ) {
		...
		$this->notices = array(
			...
			'account_already_exists' => __( 'A user account using the same email address as this Amazon account already exists.', WC_Social_Login::TEXT_DOMAIN ),
		);
	...
	public function get_default_link_button_text() {
		...
		return __( 'Amazon', WC_Social_Login::TEXT_DOMAIN );
	}
