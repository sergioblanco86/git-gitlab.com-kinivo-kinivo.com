...
class WC_Social_Login_Provider_Facebook extends WC_Social_Login_Provider {
	...
	public function __construct( $base_auth_path ) {
		...
		$this->notices = array(
			...
			'account_already_exists' => __( 'A user account using the same email address as this Facebook account already exists.', WC_Social_Login::TEXT_DOMAIN ),
		);
	...
	public function get_default_link_button_text() {
		...
		return __( 'Facebook', WC_Social_Login::TEXT_DOMAIN );
	}
