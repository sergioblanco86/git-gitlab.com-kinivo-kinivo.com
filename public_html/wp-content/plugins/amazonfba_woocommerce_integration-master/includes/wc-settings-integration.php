...
class AmazonFBA_WC_Integration_Settings extends WC_Integration {
	...
	public function __construct() {
     ...
     To receive MWS credentials you first need an Amazon <i>Professional</i> merchant account. You can sign up for an account <a href="https://www.amazon.com/sell" target="_blank">here</a>.', 'amazonfba2woo' );
        ...
        $this->AmzFBA_notif_email_addr   = $this->get_option( 'AmzFBA_Notification_email_address' );
	...
	public function init_form_fields() {
      ...
      'AmzFBA_OrderComment' => array(
        ...
        'desc_tip'            => false,
			...
			'AmzFBA_Notification_email_address'	 	=> array(
				'title'               => __( 'Notification email address', 'amazonfba2woo' ),
				'type'                => 'text',
				'default'             => '',
				'description'         => __( 'Email address to which important/urgent notifications will be sent (will not be sent if this is empty)' , 'amazonfba2woo' ),
				'desc_tip'            => false,
			),
            'AmzFBA_Debug' => array(
