...
class WC_Amazon_Payments_Advanced {
	...
	*/
	...
	public function address_widget() {
		...
		?>
		<div class="col2-set woocommerce-step" data-step="1">
			<div class="col-1">
				<?php
				if ( $woocommerce->cart->needs_shipping() ) {
					?><h3 class="amazon-h3"><?php _e( 'Shipping Address', 'woocommerce' ); ?></h3><?php
				} else {
					?><h3 class="amazon-h3"><?php _e( 'Your Address', 'woocommerce' ); ?></h3><?php
				}
				?>
	...
	public function payment_widget() {
		?>
			<div class="col-2">
				<h3 class="amazon-h3"><?php _e( 'Payment Method', 'woocommerce' ); ?></h3>
