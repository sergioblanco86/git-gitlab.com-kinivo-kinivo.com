...
public static function popup_message() {
    ...
    public static function add_to_wishlist_button( $url, $product_type, $exists ) {
        ...
        $classes = get_option( 'yith_wcwl_use_button' ) == 'yes' ? 'class="add_to_wishlist single_add_to_wishlist button alt grey standar-nowidth"' : 'class="add_to_wishlist button grey standar-nowidth"';
        ...
        $html .= '<div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;"><a class="button grey standar-nowidth" href="' . esc_url( $url ) . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Browse Wishlist', 'yit' ) ) . '</a><span class="feedback">' . __( 'Product added!','yit' ) . '</span> </div>';
        $html .= '<div class="yith-wcwl-wishlistexistsbrowse ' . ( $exists ? 'show' : 'hide' ) . '" style="display:' . ( $exists ? 'block' : 'none' ) . '"><a class="button grey standar-nowidth" href="' . esc_url( $url ) . '">' . apply_filters( 'yith-wcwl-browse-wishlist-label', __( 'Browse Wishlist', 'yit' ) ) . '</a><span class="feedback">' . __( 'The product is already in the wishlist!', 'yit' ) . '</span> </div>';
